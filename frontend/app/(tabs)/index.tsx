...
import { BusinessListItem } from '../../src/components/business/BusinessListItem';
...
const categories: { id: BusinessType; label: string; icon: keyof typeof Ionicons.glyphMap; color: string }[] = [
  { id: 'barber', label: 'Barbers', icon: 'cut', color: '#A8D1FF' },
  { id: 'hairstylist', label: 'Hairstylists', icon: 'water', color: '#FFB6D9' },
];
